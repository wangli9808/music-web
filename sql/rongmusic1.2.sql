...
CREATE TABLE `music`  (
  ...
  `music_isVIP` int(10) NULL DEFAULT NULL,
...
-- Records of music
-- ----------------------------
INSERT INTO `music` VALUES (1, '告白气球', 1, 'music/ 告白气球.mp3', 'music/lyric', 'music/1.', 1);
INSERT INTO `music` VALUES (2, '童话镇', 3, 'music/童话镇.mp3', 'music/lyric', 'music/1.', 0);
